...
describe('HomeComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [
        CoursesModule,
        NoopAnimationsModule, // stops animations from running during test.
      ],
      providers: [
        // this overwrites the CoursesService in the CoursesModule with a test one.
  ...
  it("should display only beginner courses", () => {
    // this is all synchronous.  which is good.
  ...
  // done is a Jasmine utility function
  it("should display advanced courses when tab clicked", (done: DoneFn) => {
    coursesService.findAllCourses.and.returnValue(of(setupCourses()));
    fixture.detectChanges();
    const tabs = el.queryAll(By.css(".mat-tab-label"));
    expect(tabs.length).toBe(2, "Unexpected number of tabs found");
    // a couple of alternatives for simulating the click action
